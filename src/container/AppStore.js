...
import { NavBar, Icon,WhiteSpace,WingBlank,SearchBar,Carousel,Grid} from 'antd-mobile';
            ...
            <div>
               <NavBar
                    ...
                    <div>
                        ...
                        <img src={require('../image/chabei.png')} style={{width:'100%'}} alt=""/>
                        <p style={{margin:'0'}}>Top Art Studio</p>
                        <p style={{margin:'0'}}>￥39.95</p>

                        </div>
                        <div style={{float:'left',width:'50%'}}>
                        <img src={require('../image/biao.png')} style={{width:'100%'}} alt=""/>
                    ...
                    <WingBlank>
                    <div>
                        <img src={require('../image/bg2.png')} style={{width:'100%'}} alt=""/>
                    </div>
                    </WingBlank>
            </div>
        )
